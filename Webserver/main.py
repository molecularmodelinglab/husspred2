...
import sys
sys.path.append('/home/jwellni_unc_edu/huss-pred-webtool')
from huss_pred.huss_pred import MODEL_DICT

sys.path.append('/home/jwellni_unc_edu/huss-pred-webtool/Webserver')
